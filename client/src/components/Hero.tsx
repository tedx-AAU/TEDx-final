  ...
  return (
    <div className="relative h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl">
        <h2 className="text-red-600 font-oswald text-xl md:text-2xl font-bold tracking-[0.4em] mb-6 uppercase">
          TEDxJabal Tareq
        </h2>
        <h1 className="text-white font-oswald text-6xl md:text-9xl font-extrabold mb-8 leading-none tracking-tighter">
